                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Name:</label>
                            <input type="text" class="form-control" placeholder="admin" value="{{ $user->name }}"
                                name="name" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="role" data-fouc>
                                ...
                                @foreach ($roles as $item)
                                    <option value="{{ $item->id }}" @if(in_array($item->id, $user->roles->pluck('id')->toArray())) selected @endif>{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>

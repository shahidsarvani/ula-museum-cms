...
class StoreSlideRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'content_en' => 'required',
            'content_ar' => 'required',
            'image_en' => 'required|image|file|size:2048',
            'image_ar' => 'required|image|file|size:2048',
            'sort_order' => 'required',

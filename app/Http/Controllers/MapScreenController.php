...
class MapScreenController extends Controller
{
    ...
    {
        return view('map_screens.create');
    }
...
//        try {
            ...
            Screen::create($data);
            return redirect()->route('map.screens.index')->with('success', 'Map Screen is added!');
//        } catch (\Throwable $th) {
...
//        }
    ...
    public function edit($id)
    {
        ...
        return view('map_screens.edit', compact('screen'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $screen->update($data);
            return redirect()->route('map.screens.index')->with('success', 'video_wall Screen is updated!');
        } catch (\Throwable $th) {
            Log::error($th->getMessage());
            return redirect()->back()->with('error', 'Error: Something went wrong!');
        }
    ...
    public function destroy($id)
    {
        ...
        try {
            $screen = Screen::find($id);
            $screen->delete();
            return redirect()->route('map.screens.index')->with('success', 'Map Screen is deleted!');
        } catch (\Throwable $th) {
            Log::error($th->getMessage());
            return redirect()->back()->with('error', 'Error: Something went wrong!');
        }
